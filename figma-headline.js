(()=>{
  function mountHeadline(){
    ...
    style.textContent=`
      ...
      .headline-hari-ini__label{
        flex:0 0 auto;
        display:flex;
        align-items:center;
        gap:8px;
      }
      .headline-hari-ini__bar{
        width:4px;
        height:20px;
        border-radius:1px;
        background:linear-gradient(90deg,#ff6600,#ff3300);
      }
      .headline-hari-ini__title{
        margin:0;
        color:#0042a5;
        font-size:16px;
        line-height:36px;
      ...
      .headline-hari-ini__cta{
        ...
        border-radius:50px;
        background:#fff;
        box-shadow:0 3px 1.9px rgba(0,0,0,.04);
        color:#0042a5;
        display:flex;
        align-items:center;
        ...
        line-height:1;
        font-weight:500;
        letter-spacing:-.0935px;
        cursor:pointer;
      }
      .headline-hari-ini__cta img{
        display:block;
        width:6px;
        height:10px;
        object-fit:contain;
    ...
    section.innerHTML=`
      <div class="headline-hari-ini__label">
        <span class="headline-hari-ini__bar"></span>
        <p class="headline-hari-ini__title">Headline Hari ini :</p>
      </div>
      <div class="headline-hari-ini__story">Gelombang Baru COVID-19 di Indonesia, Bagaimana Langkah Penanganannya?</div>
      <button class="headline-hari-ini__cta" type="button">
        <span>Selengkapnya</span>
        <img src="https://www.figma.com/api/mcp/asset/18c2c996-3642-4edd-ad75-7f9effb31d7d.svg" alt="">
      </button>`;
